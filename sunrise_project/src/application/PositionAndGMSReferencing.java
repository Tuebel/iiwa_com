...
public class PositionAndGMSReferencing extends RoboticsAPIApplication {
    ...
    public void run()
    {
        ...
        if (allAxesMastered)
        {
            ...
            performMotion(new JointPosition(Math.toRadians(92.53),
            ...
            //Position #4 have change
            performMotion(new JointPosition(Math.toRadians(-15.0), //(-48.66),
                                            Math.toRadians(40.0), //(24.68),
                                            Math.toRadians(-11.52), //(-11.52),
                                            Math.toRadians(20), //(10.48),
                                            Math.toRadians(-11.38), //(-11.38),
                                            Math.toRadians(-20.7), //(-20.70),
                                            Math.toRadians(20.87))); //(20.87)));

            performMotion(new JointPosition(Math.toRadians(-77.01),
